...
VISIBLE_PREFIX int UTF8StrLength PROTOARGs((const char *, int));
VISIBLE_PREFIX int UTF8CharLength PROTOARGs((const char *));
...
VISIBLE_PREFIX int UTF8CharAtLength PROTOARGs((const char *, int));
VISIBLE_PREFIX int UTF8StrLengthFromCharAt PROTOARGs((const char *, int));
