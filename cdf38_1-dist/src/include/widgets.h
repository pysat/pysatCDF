...
/*int key;*/                    /* Key entered causing exit from menu. */
  ...
  ***************************************************************************/
  ...
  int curLen;                   /* Current character length of value. */
  int curWidthLen;              /* Current width length of value. */
  int NvCols;                   /* Number of columns in value section. */
  int vRow;                     /* Row number value is on. */
  int vLcol;                    /* Left-most column of value. (= 3) */
