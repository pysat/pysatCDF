...
{
  int curLen = UTF8StrLength(field, (int)strlen(field));
...
WINDOWid wid;
char *string;
int len;			/* The number of characters - not bytes */
int row;
int col;
int eraseMode;
int rendition;
